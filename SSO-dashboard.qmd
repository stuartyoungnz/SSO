...
This document reports the latest counts of single sign-on user accounts at Auckland Council.
...
```{r}
#| label: read from CSV and process
#| include: false
...
*Report last updated: `r max_date$max_date`*

The total number of SSO accounts created each year is shown in the table below, along with the number and percentage that were used within the last 6 months.
...
The total number of SSO accounts created each month is shown in the chart below.
